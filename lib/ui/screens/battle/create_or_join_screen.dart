...
class _CreateOrJoinRoomScreenState extends State<CreateOrJoinRoomScreen> {
  ...
  // common styles
  get _boldTextStyle => TextStyle(
        fontWeight: FontWeight.bold,
        fontSize: 18.0,
        color: Theme.of(context).colorScheme.background,
      );

  // get _btnStyle => TextButton.styleFrom(
          ...
          builder: (context) => AlertDialog(
            ...
            actions: [
              ...
              CupertinoButton(
                ...
                child: Text(localisedValueOf("noBtn")),
              ),
            ],
          ),
        );
  ...
  void showJoinRoomBottomSheet() {
    final joinRoomCode = TextEditingController();
                      ...
                      child: BlocConsumer<BattleRoomCubit, BattleRoomState>(
                        ...
                        builder: (context, state) {
                          return CustomRoundedButton(
                            ...
                            height: 50,
                            onTap: () {
                              if (joinRoomCode.text.trim().isNotEmpty) {
                                final code = joinRoomCode.text.trim();

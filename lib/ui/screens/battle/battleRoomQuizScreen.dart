...
class BattleRoomQuizScreen extends StatefulWidget {
  ...
  const BattleRoomQuizScreen({
    super.key,
    this.battleLbl,
    required this.isTournamentBattle,
  });
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.paused) {
      ...
      if (!context
          ...
          .opponentLeftTheGame(context.read<UserDetailsCubit>().getUserId())) {
    ...
    return PositionedDirectional(
      ...
      child: BlocBuilder<BattleRoomCubit, BattleRoomState>(
        ...
        builder: (context, state) {
          if (state is BattleRoomUserFound) {
            UserBattleRoomDetails currentUserDetails =
            ...
            print(
                "indexCurrentAnswer :- ${currentUserDetails.correctAnswers.toString()}");
            return UserDetailsWithTimerContainer(
              correctAnswers: currentUserDetails.correctAnswers.toString(),
              isCurrentUser: true,
      ...
      child: BlocBuilder<BattleRoomCubit, BattleRoomState>(
        ...
        builder: (context, state) {
          if (state is BattleRoomUserFound) {
            ...
            //it contains correct answer by respective user and user name
            print(
                "CurrentAnswer${opponentUserDetails.correctAnswers.toString()}");
            return UserDetailsWithTimerContainer(
              correctAnswers: opponentUserDetails.correctAnswers.toString(),
              isCurrentUser: false,

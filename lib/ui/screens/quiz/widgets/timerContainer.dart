...
class TimerContainerState extends State<TimerContainer> {
  ...
  //timercall back will be executed every one second
  ...
  late final isSelfChallenge = widget.quizType == QuizTypes.selfChallenge;
  late final height = isSelfChallenge ? 45.0 : 35.0;
  late final width = isSelfChallenge ? 85.0 : 60.0;
  late final fontSize = isSelfChallenge ? 16.0 : 19.5;
  late final padding = isSelfChallenge
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Image.asset("assets/images/time.png", fit: BoxFit.cover),
          Center(
            child: Padding(
              padding: padding,
              child: Text(
